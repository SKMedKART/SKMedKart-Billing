...
public class ReminderReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (customer == null || customer.trim().isEmpty()) customer = "Customer";
        if (message == null || message.trim().isEmpty()) message = "Medicine refill reminder";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                    CHANNEL_ID, "SKMedKART Reminders",
        ...
        builder.setSmallIcon(android.R.drawable.ic_dialog_info)
                .setContentTitle("SKMedKART")
                .setContentText(customer + ": " + message)
                .setAutoCancel(true)
                .setContentIntent(pi);
